...
void UnityAssertEqualFloatArray(UNITY_PTR_ATTRIBUTE const UNITY_FLOAT
                                    ...
                                    * expected,
                                UNITY_PTR_ATTRIBUTE const UNITY_FLOAT * actual, const UNITY_UINT32 num_elements, const char * msg,
...
void UnityAssertEqualDoubleArray(UNITY_PTR_ATTRIBUTE const UNITY_DOUBLE
                                     ...
                                     * expected,
                                 UNITY_PTR_ATTRIBUTE const UNITY_DOUBLE * actual, const UNITY_UINT32 num_elements, const char * msg,
                                 const UNITY_LINE_TYPE lineNumber, const UNITY_FLAGS_T flags)
{
    UNITY_UINT32 elements                                 = num_elements;
